![](https://github.com/foundryvtt/shmn/blob/master/ui/official/shmn-repo.jpg?raw=true)
...
https://raw.githubusercontent.com/foundryvtt/shmn/master/system.json

If you wish to manually install the system, you must clone or extract it into the `Data/systems/shmn` folder. You
may do this by cloning the repository or downloading a zip archive from the
[Releases Page](https://github.com/foundryvtt/shmn/releases).
